...
public class employeeDao {
	...
	public void connect() { 
		...
		tx = ss.beginTransaction();
                                                      ...
                                                      // method which is use for add employee
	public void addEmployee(employee s) { 
		...
		ss.close();
	                                                          ...
	                                                          //  method which is use for add fresher employee
	public void addEmployee(fresherEmployee f) { 
		...
		ss.close();
	                                                                 ...
	                                                                 // method which is use for add Experience employee
	public void addEmployee(experienceEmployee x) { 
		...
		ss.close();
	                                                                                 ...
	                                                                                 // method which is use for getDetails of employee
	public employee getDetails(int empId) { 
		...
		return ep;
	                                                                          ...
	                                                                          //  method which is use for delete employee
